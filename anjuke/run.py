...
class AJK_Slide_Captcha():
    ...
    def get_sessionId(self, captcha_url):
        ...
        sessionId = re.search(r'name="sessionId".*?value="(.*)?"', resp.content.decode('utf-8')).group(1)
        return sessionId
    ...
    def run(self):
        ...
        # url ="https://www.anjuke.com/captcha-verify/?callback=shield&from=antispam&serialID=49ce3060dcbf7ec9ffa20ea469380e78_043cb9b6841840d7ae8501d760672461&history=aHR0cHM6Ly9zaGFuZ2hhaS5hbmp1a2UuY29tL3Byb3Avdmlldy9BMTYzMzAzNzY1OT9mcm9tPWZpbHRlci1zYWxlc3hxJnNwcmVhZD1jb21tc2VhcmNoX3AmdHJhZGluZ19hcmVhX2lkcz02MzMyJnJlZ2lvbl9pZHM9MTEmcG9zaXRpb249MzIxJmt3dHlwZT1maWx0ZXI="
        # url_str = base64.b64encode(self.url.encode('utf-8'))
        # url_str = url_str.decode('utf-8')
        # url = "https://www.anjuke.com/captcha-verify/?callback=shield&from=antispam&serialID=49ce3060dcbf7ec9ffa20ea469380e78_043cb9b6841840d7ae8501d760672461&history={}".format(url_str)
        sessionId = self.get_sessionId(url)
        ...
        # Step 5 get trace
        (lastXpos, trace) = self.get_trace(position, traceTxtPath='/home/yl/桌面/anjuke/CaptchaTrace.txt')
